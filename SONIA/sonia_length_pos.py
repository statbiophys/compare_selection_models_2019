...
class SoniaLengthPos(Sonia):
    ...
    def __init__(self, data_seqs = [], gen_seqs = [], chain_type = 'humanTRB',
                 ...
                 min_L = 4, max_L = 30, include_indep_genes = False, include_joint_genes = True, min_energy_clip = -3, max_energy_clip = 10, seed = None,custom_pgen_model=None,l2_reg=0.0001):
